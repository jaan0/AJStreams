...
export const footerPages: Record<string, InfoPage> = {
    ...
    privacy: {
        ...
        sections: [
            ...
            { title: 'Playback reliability', text: 'Signed-in playback sends source success or failure reports to maintain availability badges. Reports use a hashed account identifier for deduplication and expire after 24 hours. We do not store the video contents. Anonymous viewers do not contribute shared reliability reports.' },
